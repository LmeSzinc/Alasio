...
from alasio.gitpython.obj.obj import GitLooseObject, GitObject, parse_loosedata
...
class LoosePath:
    def __init__(self, path):
        ...
        self.dict_object_lazy: "dict[str, object]" = {}
    ...
    def loose_read_lazy(self):
        ...
        for sha1, _ in self._loose_iter():
            dict_object_lazy[sha1] = object

        self.dict_object = {}
        self.dict_object_lazy = dict_object_lazy

    def loose_addread(self, sha1):
        """
        Args:
        ...
        self.dict_object_lazy.pop(sha1, None)
