...
from alasio.ext.gitpython.obj.obj import OBJTYPE_BASIC, parse_objdata
from alasio.ext.gitpython.obj.objdelta import parse_ofs_delta_offset, parse_ref_delta_ref
