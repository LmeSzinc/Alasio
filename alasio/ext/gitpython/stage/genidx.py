...
from alasio.ext.gitpython.obj.obj import GitObject, OBJTYPE_BASIC, parse_objdata_return_info
from alasio.ext.gitpython.obj.objdelta import OfsDeltaObj, RefDeltaObj, parse_delta_object, parse_ofs_delta_info
